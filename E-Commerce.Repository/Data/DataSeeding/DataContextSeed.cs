...
namespace E_Commerce.Repository.Data.DataSeeding
{
    public static class DataContextSeed
    {
        public static async Task SeedDataAsync(DataContext context)
        {
			...
			{
				var strings = await File.ReadAllTextAsync(@"..\E-Commerce.Repository\Data\DataSeeding\delivery.json");
				var methods = JsonSerializer.Deserialize<List<DeliveryMethod>>(strings);
